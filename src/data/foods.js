// per 100g
export const foods = [
  { id:'chicken_breast', name:'חזה עוף מבושל', kcal:165, p:31, c:0, f:3.6, cat:'חלבון' },
  ...
  { id:'greek_yogurt', name:'יוגורט יווני 2%', kcal:73, p:10, c:3.6, f:1.9, cat:'חלבון' },
  { id:'cottage', name:'קוטג׳ 5%', kcal:98, p:11, c:3.4, f:5, cat:'חלבון' },
  { id:'whey', name:'אבקת חלבון (מנה 30ג)', kcal:120, p:24, c:3, f:1, cat:'חלבון' },
  ...
  { id:'oats', name:'שיבולת שועל יבשה', kcal:389, p:16.9, c:66, f:6.9, cat:'פחמימה' },
  ...
  { id:'bread_whole', name:'לחם מחמצת מלא', kcal:247, p:9, c:41, f:3.4, cat:'פחמימה' },
  ...
  { id:'peanut_butter', name:'חמאת בוטנים', kcal:588, p:25, c:20, f:50, cat:'שומן' },
  ...
  { id:'dark_choc', name:'שוקולד מריר 70%', kcal:598, p:7.8, c:46, f:43, cat:'קינוח' },
]
