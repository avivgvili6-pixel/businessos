...
export const GOALS = {
  ...
  strength:    { he: 'כוח',         en: 'Strength',    icon: '🏋️' },
...
export const PROGRAMS = [
  ...
  pg('beginner_ppl_gym', 'Beginner Push/Pull/Legs (Gym)', {
    emoji: '🏋️', level: 'beginner', goal: 'gain_muscle', equipment: 'gym',
  ...
  pg('beginner_strength_gym', 'Beginner Strength (Gym)', {
    emoji: '🏋️', level: 'beginner', goal: 'strength', equipment: 'gym',
  ...
  pg('travel_no_equipment', 'Travel / Vacation (No Equipment)', {
    emoji: '✈️', level: 'beginner', goal: 'gain_muscle', equipment: 'none',
  ...
  pg('intermediate_ppl_gym', 'Intermediate Push/Pull/Legs (Gym)', {
    emoji: '🏋️', level: 'intermediate', goal: 'gain_muscle', equipment: 'gym',
  ...
  pg('intermediate_bro_split', 'Intermediate Bro Split (5-Day)', {
    emoji: '🏋️‍♂️', level: 'intermediate', goal: 'gain_muscle', equipment: 'gym',
  ...
  pg('intermediate_strength_gym', 'Intermediate Strength (Gym)', {
    emoji: '🏋️', level: 'intermediate', goal: 'strength', equipment: 'gym',
  ...
  pg('intermediate_recomp', 'Body Recomposition', {
    emoji: '⚖️', level: 'intermediate', goal: 'lose_weight', equipment: 'gym',
  ...
  pg('advanced_fb_gym', 'Advanced Full-Body (Gym Equipment)', {
    emoji: '🏋️', level: 'advanced', goal: 'gain_muscle', equipment: 'gym',
  ...
  pg('advanced_bro_split', 'Advanced Bro Split (5-Day)', {
    emoji: '🏋️‍♂️', level: 'advanced', goal: 'gain_muscle', equipment: 'gym',
...
export const ROUTINE_CATEGORIES = [
  ...
  { key: 'strength',   he: 'כוח',           en: 'Strength',      icon: '🏋️', filter: p => p.goal === 'strength' },
